          ...
          <div className="about-intro">
            ...
            <div className="col about-copy-wrapper">
              ...
              <div className="about-copy" ref={aboutCopyRef}>
                <h3>
                With a strong foundation in finance and a passion for data-driven insights, Dai Yuxin combines analytical expertise with a deep understanding of business strategy. Born in Nanning and educated in Harbin, she is now pursuing a master’s in Business Intelligence in Hong Kong to refine her skills in turning data into actionable solutions.
                </h3>
                <br />
                <h3>
                Dai excels at uncovering patterns and crafting stories from complex datasets, aiming to drive smarter decisions and strategic growth. Her focus lies in bridging the gap between data analysis and business needs, aspiring to roles like Data Analyst or Business Analyst where she can make a meaningful impact.
                </h3>
                <br />
                <h3>
                Driven by curiosity and a commitment to continuous learning, Dai embraces cutting-edge tools and methodologies to stay ahead in the ever-evolving landscape of analytics. She’s not just a data enthusiast—she’s a problem solver ready to transform challenges into opportunities.
                </h3>
              </div>
            </div>
          </div>
